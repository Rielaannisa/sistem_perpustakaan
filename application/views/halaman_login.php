...
<head>
    ...
    <link type="text/css" href="<?php echo base_url() ?>asset/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="<?php echo base_url('login/do_login') ?>" method="post">
                                        ...
                                        <input type="submit" name="simpan" value="LOGIN" class="btn btn-primary btn-block">
                                    </form>
